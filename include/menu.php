...
<nav class="blue-grey darken-5">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> PT</a>
                ...
                <div class="logo-side center red darken-5">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                echo '<img class="logoside" src="./upload/logo3.png"/>';
                            } else {
                                echo '<img class="logoside" src="./asset/img/logo.png"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">SMK  DWIGUNA DEPOK</h5>';
                            } else {
                                echo '<h5 class="smk-side">SMK  DWIGUNA DEPOK</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">Citayem, Bogor, Jawab Barat</p>';
                            } else {
                                echo '<p class="description-side">Citayem, Bogor, Jawab Barat</p>';
                            }
                        }
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> PT</a></li>
            <li><div class="grs"></></li>
